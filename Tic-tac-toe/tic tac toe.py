...
space_1.speed(0)
space_1.shape("square")
space_1.color("white")
space_1.penup()
space_1.shapesize(stretch_wid=1, stretch_len=600)
space_1.goto(0, 110)

space_2 = turtle.Turtle()
space_2.speed(0)
space_2.shape("square")
space_2.color("white")
space_2.penup()
space_2.shapesize(stretch_wid=1, stretch_len=600)
space_2.goto(0, -90)

space_3 = turtle.Turtle()
space_3.speed(0)
space_3.shape("square")
space_3.color("white")
space_3.penup()
space_3.shapesize(stretch_wid=600, stretch_len=1)
space_3.goto(120, 0)

space_4 = turtle.Turtle()
space_4.speed(0)
space_4.shape("square")
space_4.color("white")
space_4.penup()
space_4.shapesize(stretch_wid=600, stretch_len=1)
space_4.goto(-120, 0)
